...
def bump(
    ...
    *,
    ...
    mono bump: [green]0.1.1[/]

    mono bump major: [green]1.0.0[/]

    mono bump minor: [green]0.2.0[/]

    mono bump patch: [green]0.1.1[/]

    mono bump alpha: [green]0.1.0alpha0[/]

    mono bump dev: [green]0.1.0dev0[/]

    mono bump post: [green]0.1.0post0[/]

    mono major alpha: [green]1.0.0alpha0[/]
    """
